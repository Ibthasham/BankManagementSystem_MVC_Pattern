...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem () {
		...
		super ("BankSystem of Ibthasham [Pvt] Limited.");
		...
		author = new JLabel (" " + "BankSystem of Ibthasham [Pvt] Limited.", Label.LEFT);
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			String msg = "BankSystem of Ibthasham [Pvt] Limited.\n\n" + "MVC Created & Designed By:\n" + 
				"Ibthasham Amin Emon\n\n" + "E-mail me:\nibthasham.amin.emon@g.bracu.ac.bd";
	...
	private void quitApp () {
		...
		try {
			...
			if (reply == JOptionPane.YES_OPTION) {
				...
				System.out.println ("Thanks for Using the BankSystem \nCopyright © 2021 Ibthasham Amin Emon");
	...
	String makeRecordPrint (int rec) {
		...
		String data;
		String data0 = "               BankSystem of Ibthasham [Pvt] Limited.               \n";	//Page Title.
		...
		String data6 = "          Copyright © 2021 Ibthasham Amin Emon.\n";	//Page Footer.
		String sep0 = " -----------------------------------------------------------\n";
		String sep1 = " -----------------------------------------------------------\n";
		String sep2 = " -----------------------------------------------------------\n";
		String sep3 = " -----------------------------------------------------------\n";
